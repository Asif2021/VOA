...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Audio Lectures</h1>
                <a href="{{ route('teacher.material.audio.create') }}" class="btn btn-outline-success btn-lg pull-right">Upload Audio Lectures</a>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
