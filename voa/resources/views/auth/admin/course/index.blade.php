                        ...
                        <table width="100%" class="table table-bordered table-hover" id="dataTables-example">
                            ...
                            @foreach($courses as $course)
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{ $course->subjects->count() }} <a href="{{ route('admin.course.subject.index', $course->id) }}">View</a></td>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.course.destroy', $course->id) }}" method="POST">
                                            ...
                                            @endif
                                            <a href="{{ route('admin.course.show', $course->id) }}" class="btn-link"><i class="fa fa-"></i></a>
                                            <a href="{{ route('admin.course.edit', $course->id) }}" class="btn-link"><i class="fa fa-edit fa-fw"></i></a>
