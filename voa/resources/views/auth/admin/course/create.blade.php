                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-2">
                                <form role="form" method="POST" action="{{ route('admin.course.store') }}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group {{ $errors->first('course_code') ? 'has-error' : 'has-success' }}">
                                        <label>Course Code</label>
                                        <input type="text" name="course_code" class="form-control" value="{{ old('course_code') }}" tabindex="2">
                                        <p class="help-block">{{ $errors->first('course_code') ? $errors->first('course_code') : '' }}</p>
                                    </div>
